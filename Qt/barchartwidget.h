...
/**
 * @brief La classe BarChartWidget crea un widget per visualizzare grafici a barre utilizzando la libreria QtCharts.
 */
...
public:
    ...
    QBarCategoryAxis *axisX;     /**< Puntatore all'asse X (asse delle categorie) per il grafico a barre. */
    QValueAxis *axisY;           /**< Puntatore all'asse Y (asse dei valori) per il grafico a barre. */
