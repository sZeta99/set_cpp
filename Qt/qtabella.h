...
/**
 * @brief La classe Serie rappresenta un set di stringhe utilizzando la classe template Set.
 */
typedef Set<std::string, std::equal_to<std::string>, std::allocator<std::string>> Serie;

/**
 * @brief La struttura dipinto rappresenta un'entità dipinto con attributi specifici.
 */
struct dipinto
{
     ...
     */
    dipinto(const std::string &s, const std::string &a, const std::string &st, const std::string &d, const std::string &sl)
    ...
    bool operator==(const dipinto &other) const
    {
        return scuola == other.scuola &&
               autore == other.autore &&
               soggetto_o_titolo == other.soggetto_o_titolo &&
               data == other.data &&
               sala == other.sala;
    }
};
...
/**
 * @brief La classe DipintoSet rappresenta un set di dipinti utilizzando la classe template Set.
 */
