...
/**
 * @brief La classe MainWindow rappresenta la finestra principale
 * dell'applicazione.
 */
...
private:
  ...
  PieChartWidget *pieChartWidget; /**< Puntatore all'oggetto del widget del
                                     grafico a torta. */
  BarChartWidget *barChartWidget; /**< Puntatore all'oggetto del widget del
                                     grafico a barre. */
