...
public:
    ...
    inline bool operator()(const dipinto &e) const { return e.soggetto_o_titolo.find(soggetto_o_titolo) != std::string::npos; }
...
void MainWindow::remove()
{
    ...
    {
        QMessageBox *errorDialog = new QMessageBox(QMessageBox::Critical, "Error", "Indice non trovato", QMessageBox::Ok, this);
