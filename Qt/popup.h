...
/**
 * @brief La classe PopUp rappresenta una finestra di dialogo per l'aggiunta di
 * nuovi dipinti.
 */
...
public:
   ...
   * @param dipint_ptr Puntatore al set di dipinti su cui verranno apportate le
   * modifiche.
...
private:
  QLineEdit
      *scuolaLineEdit; /**< LineEdit per inserire la scuola del dipinto. */
  QLineEdit *autoreLineEdit; /**< LineEdit per inserire l'autore del dipinto. */
  QLineEdit *soggettoTitoloLineEdit; /**< LineEdit per inserire il soggetto o il
                                        titolo del dipinto. */
  ...
  QPushButton
      *aggiungiDipintoButton; /**< Pulsante per aggiungere il dipinto. */
  DipintoSet *dipint_ptr;     /**< Puntatore al set di dipinti su cui verranno
